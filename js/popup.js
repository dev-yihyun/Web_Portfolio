document.getElementById("modal_open_btn").onclick = function() {
    document.getElementById("web_portfolio").style.display="block";
}
document.getElementById("modal_close_btn").onclick = function() {
    document.getElementById("web_portfolio").style.display="none";
}   
document.getElementById("hangman_open_btn").onclick = function() {
    document.getElementById("hangman").style.display="block";
}
document.getElementById("hangman_close_btn").onclick = function() {
